...
pub struct Chain {
    ...
    tx_routing_height_horizon: Option<BlockHeightDelta>,
}
...
impl Chain {
    ...
    pub fn new_for_view_client(
        ...
        Ok(Chain {
            ...
            tx_routing_height_horizon: Some(tx_routing_height_horizon),
        })
    }
    ...
    pub fn new(
        ...
        Ok(Chain {
            ...
            tx_routing_height_horizon: None,
        })
    }
    ...
    pub fn find_validator_for_forwarding(&self, shard_id: ShardId) -> Result<AccountId, Error> {
        ...
        self.find_chunk_producer_for_forwarding(
            &epoch_id,
            shard_id,
            self.tx_routing_height_horizon.unwrap(),
        )
    }
