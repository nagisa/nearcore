...
use near_store::{
    get_account, set_access_key, set_account, KeyLookupMode, MissingTrieValueContext, ShardTries, StorageError, Trie
};
...
fn test_main_storage_proof_size_soft_limit() {
    ...
    assert_matches!(
        storage.get_mode(&code_key.to_vec(), KeyLookupMode::Trie),
